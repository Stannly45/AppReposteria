...
public class TinyDB {
    ...
    public ArrayList<ProductoDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ProductoDomain> playerList =  new ArrayList<ProductoDomain>();

        for(String jObjString : objStrings){
            ProductoDomain player  = gson.fromJson(jObjString,  ProductoDomain.class);
    ...
    public void putListObject(String key, ArrayList<ProductoDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(ProductoDomain player: playerList){
